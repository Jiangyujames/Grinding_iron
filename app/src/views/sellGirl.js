...
class sellGirl extends React.Component{
    constructor(){
        super();
...
function mapDispatchToProps(dispatch) {
    return {
        getsellWellList(){
            ...
            axios.get("https://app2.motie.com/ranking?rankType=9&sex=2&pageNo=1&siteId=99&timeLimit=4&group=1&pageSize=10")
                .then(({data})=>{
...
export default connect(mapStateToProps,mapDispatchToProps)(sellGirl)